...
void objective(Chromosome* c){
    ...
    c->result = aa * c->gene[0].geneticcode * c->gene[0].geneticcode * c->gene[0].geneticcode + \
                bb * c->gene[0].geneticcode * c->gene[0].geneticcode + \
                cc * c->gene[0].geneticcode + \
                dd;
;
